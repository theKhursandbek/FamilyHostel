 ...
 *
 * Renders the stats relevant to a single Administrator account:
 * today's bookings, revenue, room occupancy, current cash session
 * and active shift. Subscribes to the "admin" WebSocket channel
 * for real-time refreshes.
 */
