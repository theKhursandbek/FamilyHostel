...
const columns = [
  {
    key: "account_name",
    title: "User",
    render: (row) => row.account_name || row.account_full_name || `#${row.account}`,
  },
  {
    key: "role",
    title: "Role",
  ...
  },
  {
    key: "branch_name",
    title: "Branch",
    render: (row) => row.branch_name || `Branch #${row.branch}`,
  },
  {
    key: "shift_type",
    title: "Shift",
    render: (row) => SHIFT_LABELS[row.shift_type] || row.shift_type,
  },
  {
    key: "date",
    title: "Date",
